                ...
                >
                    ...
                    <template slot="operation" slot-scope="lineData">
                        <div class="flex j-ey a-c">
                            <a @click="reRetUseInfo(lineData)" v-permission="'admin:setting:userList:update'">编辑</a>
                            <a v-permission="'admin:setting:userList:disable'"
                               @click="updateStatus({ id: lineData.id, status: lineData.enabled })">
...
<!--                    </template>-->
        ...
        <!--   删除     -->
        <a-modal v-model="deleteOpen" title="确认删除" @ok="handleOk">
            <p>此操作不可逆，请确认</p>
        </a-modal>
    </div>
</template>
